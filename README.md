...
Swagger (cloud) -> [live swagger](https://projeto-fiap-identicacao-64.cloud/swagger-ui/index.html#/)
...
```
docker build . -t rm350010/projeto-fiap-identicacao-1

docker login --username=rm350010

#informar senha

docker push rm350010/projeto-fiap-identicacao-1:latest
```
### Para acessar o swagger
